    ...
    public GridToGamePieceWithArcPath(AutoSelector.StartingPosition startPosition) {
        ...
        switch(startPosition) {
            ...
            case BLUE_COMMUNITY_LEFT:
                trajectory = PathPlanner.loadPath("Blue Left Grid To Game Piece With Arc", new PathConstraints(0.5, 0.2), true);
                break;
            ...
            case RED_COMMUNITY_RIGHT:
                trajectory = PathPlanner.loadPath("Red Right Grid To Game Piece With Arc", new PathConstraints(0.5, 0.2), true);
                break;
            default:
                break;
