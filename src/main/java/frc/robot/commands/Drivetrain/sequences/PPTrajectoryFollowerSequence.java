...
public class PPTrajectoryFollowerSequence extends SequentialCommandGroup {

  /** Creates a new PPTrajectoryFollowerSequence without reseting the position of the robot. */
  public PPTrajectoryFollowerSequence(Drivetrain drive, AutoPaths autoPath) {
  ...
  /** Creates a new PPTrajectoryFollowerSequence, reseting the position of the robot at the beginning of the sequence. */
  public PPTrajectoryFollowerSequence(Drivetrain drive, AutoPaths autoPath, Pose2d position) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    SetVisionImplementationCommand preventVisionImplementation = new SetVisionImplementationCommand(drive, true);
