 ...
 */
public class LambdaRamseteCommand extends CommandBase {
  ...
  /**
   * Constructs a new LambdaRamseteCommand that, when executed, will follow the provided trajectory. PID
   * control and feedforward are handled internally, and outputs are scaled -12 to 12 representing
   * units of volts. 
   * 
   * <p>This command uses the value of a trajectory supplier when the initialize() method is run
   * instead of a set trajectory passed in through the constructor.
   *
