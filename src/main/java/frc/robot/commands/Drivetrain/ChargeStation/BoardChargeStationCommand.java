...
public class BoardChargeStationCommand extends CommandBase {
  ...
  public void execute() {
    ...
    m_drivetrain.ArcadeDrive(Constants.Autonomous.BOARD_CHARGE_SPEED, 0);
  ...
  public boolean isFinished() {
    ...
    boolean dropped = maxAngle - angle > Constants.Autonomous.BOARD_CHARGE_ANGLE_CHANGE_THRESHOLD;
    boolean aboveThreshold = maxAngle > Constants.Autonomous.BOARD_CHARGE_MINIMUM_STOP_ANGLE;
