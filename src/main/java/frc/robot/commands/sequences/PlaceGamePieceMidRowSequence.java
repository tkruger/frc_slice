...
public class PlaceGamePieceMidRowSequence extends SequentialCommandGroup {
  /** Creates a new PlaceGamePieceMidRowSequence. */
  public PlaceGamePieceMidRowSequence(Elevator elevator, Wrist wrist, Intake intake) {
