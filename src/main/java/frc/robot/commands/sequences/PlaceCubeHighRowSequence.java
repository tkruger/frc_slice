...
public class PlaceCubeHighRowSequence extends SequentialCommandGroup {
  ...
  public PlaceCubeHighRowSequence(Elevator elevator, Wrist wrist, Intake intake) {
    ...
    GoToStateCommand setOutState = new GoToStateCommand(elevator, wrist, Constants.States.AUTO_HIGH_CUBE_TRANSITION_STATE_1);
    GoToStateCommand setUpState = new GoToStateCommand(elevator, wrist, Constants.States.AUTO_HIGH_CUBE_TRANSITION_STATE_2);
