...
public class PlaceGamePieceRowThreeSequence extends SequentialCommandGroup {
  /** Creates a new PlaceGamePieceRowThreeSequence. */
  public PlaceGamePieceRowThreeSequence(Elevator elevator, Wrist wrist, Intake intake) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());

    ElevatorSetCommand elevatorSetRowThree = new ElevatorSetCommand(elevator, Constants.elevator_ROW_THREE_POSITION);
    ...
    ParallelCommandGroup elevatorWristSetGroup = new ParallelCommandGroup(setWristPlacePosition, elevatorSetRowThree);
