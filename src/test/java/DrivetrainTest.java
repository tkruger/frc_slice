...
public class DrivetrainTest {
    ...
    //Define Joysticks
    public static JoystickSim leftJoystick = new JoystickSim(Constants.Joysticks.LEFT_JOYSTICK_PORT);
    public static JoystickSim rightJoystick = new JoystickSim(Constants.Joysticks.RIGHT_JOYSTICK_PORT);
