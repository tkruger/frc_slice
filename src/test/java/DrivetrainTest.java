...
public class DrivetrainTest {
    ...
    //Define Joysticks
    public static JoystickSim leftJoystick = new JoystickSim(Constants.InputDevices.LEFT_JOYSTICK_PORT);
    public static JoystickSim rightJoystick = new JoystickSim(Constants.InputDevices.RIGHT_JOYSTICK_PORT);
